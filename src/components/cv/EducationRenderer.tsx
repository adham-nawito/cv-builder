import type { EducationSection, TextBlock, ListBlock, DateRangeBlock } from '@/schemas/cv'
import { SectionHeading } from './SectionHeading'

type Props = Readonly<{ section: EducationSection; headingClassName?: string }>
...
export function EducationRenderer({ section, headingClassName }: Props) {
  return (
    <div>
